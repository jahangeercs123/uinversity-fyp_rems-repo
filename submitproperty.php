...
if(isset($_POST['add']))
{
	...
	'$loc','$city','$aimage','$aimage1','$aimage2','$aimage3','$aimage4','$uid','$status','$fimage','$fimage1','$fimage2','$totalfloor', '$isFeatured','Office')";
	$result=mysqli_query($con,$sql);
	if($result)
		{
			$msg="<p class='alert alert-success'>Office Inserted Successfully</p>";
					
		}
		else
		{
			$error="<p class='alert alert-danger'>Office Not Inserted Some Error</p>";
		}
}							
?>
<!DOCTYPE html>
...
<div id="page-wrapper">
	...
	<div class="row">
		<div class="col-md-2">
			<div class="sidebar">
				<a class="active" href="submitproperty.php">Add Apartement</a>
				<a href="addFlat.php">Add Flat</a>
				<a href="addOffice.php">Add Office</a>
				<a href="addHouse.php">Add Houses</a>
			</div>
...
<div class="description">
	<h5 class="text-secondary">Apartement Information</h5><hr>
	<?php echo $error; ?>
	<?php echo $msg; ?>
