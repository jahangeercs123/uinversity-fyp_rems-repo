                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="top-contact list-text-white  d-table">
                                <li><a href="#"><i class="fas fa-phone-alt text-success mr-1"></i>03329611333</a></li>
                                <li><a href="#"><i class="fas fa-envelope text-success mr-1"></i>bakhtmuner06@gmail.com</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4">
                                    ...
                                    <ul class="navbar-nav mr-auto">
										...
										<li class="nav-item dropdown">
											...
											<ul class="dropdown-menu">
                                                ...
                                                $q="select count(status) from messages where status='unread' and username='{$_SESSION['uemail']}'";
                                                $result=mysqli_query($con,$q);
                                                $row=mysqli_fetch_array($result);
                                                ?>
                                                <li class="nav-item"> <a class="nav-link" href="message.php">Messages <span class="badge badge-success"><?PHP echo $row['0'];?></span></a> </li>
