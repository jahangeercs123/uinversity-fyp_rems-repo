					...
					<table class="items-list col-lg-12 table-hover" style="border-collapse:inherit;">
                        <thead>
                             <tr  class="bg-dark">
                                ...
                                <th class="text-white font-weight-bolder">For</th>
						...
						<!-- FOR MORE PROJECTS visit: codeastro.com -->
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div class="property-info d-table">
                                        ...
                                        <div class="price mt-3">
											<span class="text-success">RS:&nbsp;<?php echo $row['11'];?></span>
										</div>
                                    </div>
								</td>
                                ...
                                <td>
                                    ...
                                    <?PHP }else {?>
                                        <a class="btn btn-info" href="flatUpdate.php?id=<?php echo $row['0'];?>">Update</a>
                                   <?php } ?> 
                                </td>
