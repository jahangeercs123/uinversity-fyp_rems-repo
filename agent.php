    ...
    <div class="row"> 
        ...
        <div class="full-row">
            <div class="container">
				<div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-secondary double-down-line text-center mb-5">Agent<br> Future work</h2>
                        </div>
                </div>
                <div class="row">
...
<!--                             
                    <div class="col-md-6 col-lg-4">
                        <div class="hover-zoomer bg-white shadow-one mb-4">
                            <div class="overflow-hidden"> <img src="<?php // if(file_exists($row['6'])) echo $row['6']; else if(file_exists("admin/user/1.png")) echo "admin/user/1.png";?>"  alt="aimage"> </div>
