									...
									<table id="basic-datatable" class="table table-bordered table-hover">
											...
											?>
                                                <tr>
													...
													<td><img src="../<?php   if(file_exists($row['uimage'])) echo $row['uimage']; else if(file_exists("admin/user/1.png")) echo "admin/user/1.png";?>?>" height="50px" width="50px"></td>
                                                    <td><a href="userdelete.php?id=<?php echo $row['uid']; ?>"><button class="btn btn-danger">Delete</button></a></td>
													<td><a ><button class="btn <?PHP echo $class?>"><?PHP echo $status;?></button></a></td>
