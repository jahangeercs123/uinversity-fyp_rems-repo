...
if(isset($_POST['add']))
{
	...
	totalfloor='{$totalfloor}', ptype='{$ptype}' WHERE pid = {$pid}";
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input required class="form-control" name="aimage" type="file" accept="image" value="<?php echo $row['15'];?>" >
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input required class="form-control" name="aimage2" type="file" ="">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input required class="form-control" name="aimage4" type="file" ="">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input required class="form-control" name="fimage1" type="file">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input required class="form-control" name="aimage1" type="file" ="">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input required class="form-control" name="aimage3" type="file" ="">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input required class="form-control" name="fimage" type="file">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input required class="form-control" name="fimage2" type="file" >
