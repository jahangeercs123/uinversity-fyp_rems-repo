						...
						<div class="col-xl-3 col-sm-6 col-12">
							<div class="card">
								<div class="card-body">
									...
									<h3><?php $sql = "SELECT * FROM property where ptype = 'apartment'";
										$query = $con->query($sql);
                						echo "$query->num_rows";?></h3>
						...
						<div class="col-xl-3 col-sm-6 col-12">
							<div class="card">
								<div class="card-body">
									...
									<h3><?php $sql = "SELECT * FROM property where ptype = 'House'";
										$query = $con->query($sql);
                						echo "$query->num_rows";?></h3>
						...
						<div class="col-xl-3 col-sm-6 col-12">
							<div class="card">
								<div class="card-body">
									...
									<h3><?php $sql = "SELECT * FROM property where ptype = 'Office'";
										$query = $con->query($sql);
                						echo "$query->num_rows";?></h3>
										
										<h6 class="text-muted">No. Office</h6>
										<div class="progress progress-sm">
											<div class="progress-bar bg-info w-50"></div>
										</div>
									</div>
						...
						<div class="col-xl-3 col-sm-6 col-12">
							<div class="card">
								<div class="card-body">
									...
									<h3><?php $sql = "SELECT * FROM property where ptype = 'Flate'";
										$query = $con->query($sql);
                						echo "$query->num_rows";?></h3>
