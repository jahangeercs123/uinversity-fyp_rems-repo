                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-12">
								<?php 
									...
									{
								?>
                                <div class="user-info mt-md-50"> <img class="img-circle"  style="border-radius:50%;"  width="300px" height="300px" src="<?php if(file_exists($row['6'])) echo $row['6']; else if(file_exists("admin/user/1.png")) echo "admin/user/1.png";?> " alt="userimage">
                                    <div class="mb-4 mt-3">
                                ...
                                <div>
                                    <a class="btn btn-success mt-2 btn-round" href="editProfail.php?uid=<?PHP echo md5($_SESSION['uid']);?>">Edit</a>
                                </div>
                            </div>
                        </div>
