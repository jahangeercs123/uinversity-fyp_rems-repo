...
<link rel="shortcut icon" href="images/logo/restatelg.png">
...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <div class="full-row">
            <div class="container">
                    ...
                    <div class="col-md-12">
                        <div class="tab-content mt-4" id="pills-tabContent">
                            ...
                            $offset=($page_id-1)*$limit;
                                    $query=mysqli_query($con,"SELECT property.*, user.uname,user.utype,user.uimage FROM `property`,`user` WHERE property.uid=user.uid ORDER BY date DESC LIMIT {$offset},{$limit}");
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            <div class="overlay-black overflow-hidden position-relative"> <img style="Height:370px" src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                                <div class="featured bg-success text-white">New</div>
                                                <div class="sale bg-success text-white text-capitalize">For <?php echo $row['3'];?></div>
                                                
                                                <div class="price text-primary"><b>RS:<?php echo $row['11'];?> </b><span class="text-white"><?php echo $row['10'];?> Sqft</span></div>
                                            ...
                                            <div class="featured-thumb-data shadow-one">
                                                <div class="p-3">
                                                    ...
                                                    <span class="location text-capitalize"><i class="fas fa-map-marker-alt text-success"></i> <?php echo $row['12'];?></span> 
                                                    <span class="location text-capitalize ml-5">Type : <?php echo $row['28'];?></span>
                                                </div>
                                                <div class="bg-gray quantity px-4 pt-4">
                                                    ...
                                                    <?php if($row['28']!='Flate'){?>
                                                        ...
                                                        <li><span><?php echo $row['10'];?></span> Area</li>
                ...
                if($total_rows>0){
                   ...
                   <a class="page-link" href="index.php?page='.($pages-1).'" tabindex="-1">Previous</a>
                   </li>';
                    }else{
                    ...
                    for($i=1;$i<=$pages;$i++){
                       ...
                       echo ' <li class="page-item '.$active.'"><a href=index.php?page='.$i.' class="page-link" href="#">'.$i.'</a></li>';

                }
                if($pages>$page_id){
                    echo ' <li class="page-item">
                <a class="page-link" href="index.php?page='.($pages+1).'">Next</a>
                </li> ';
                }
                else{
                    echo ' <li class="page-item disabled">
        ...
        <!--	Why Choose Us -->
        <div class="full-row living bg-one overlay-secondary-half" style="background-image: url('images/22.jfif'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
            <div class="container">
                <div class="row">
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Our Website is ranking in Top Rated Real state Website Because of its Advance Functionalities.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>User Experience is awesome with our Website</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Out Agents are very Expert and coprative.</p>
									</div>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="full-row overlay-secondary" style="background-image: url('images/breadcromb.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
            <div class="container">
                <div class="fact-counter">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="count text-center  mb-sm-50" > <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
								<?php
											...
											while($row=mysqli_fetch_array($query))
												{
                                                    $total=$row[0]
										?>
                                <div class="count-num text-success my-4" ><?php echo $total?></div>
								<?php } ?>
						...
						<div class="col-md-3">
                            <div class="count  text-center  mb-sm-50"> <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
								<?php
										...
										?>
                                <div class="count-num text-success my-4" data-speed="3000" ><?php echo $total?></div>
								<?php } ?>
                                <div class="text-white h5">Rent Property Available</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="count  text-center  mb-sm-50" > <i class="flaticon-man flat-large text-white" aria-hidden="true"></i>
                                <?php
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/1.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
									<?php
										$query=mysqli_query($con,"SELECT count(city), property.* FROM property where city='Buner'");
                                        
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['14']?>"><?php echo $row['city'];?></a></h4>
                                    <span><?php 
												$total = $row[0];
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/2.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
									<?php
										$query=mysqli_query($con,"SELECT count(city), property.* FROM property where city='swat'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['14']?>"><?php echo $row['city'];?></a></h4>
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/3.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
										$query=mysqli_query($con,"SELECT count(city), property.* FROM property where city='Mardan'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['14']?>"><?php echo $row['city'];?></a></h4>
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/4.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
										$query=mysqli_query($con,"SELECT count(city), property.* FROM property where city='Islamabad'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['14']?>"><?php echo $row['city'];?></a></h4>
