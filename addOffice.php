...
//	$kitc=$_POST['kitc'];
	...
	$sql="insert into property (title,pcontent,stype,bathroom,balcony,hall,floor,size,price,location,city,pimage,pimage1,pimage2,pimage3,pimage4,uid,status,mapimage,topmapimage,groundmapimage,totalfloor, isFeatured,ptype)
	values('$title','$content','$stype','$bath','$balc','$hall','$floor','$asize','$price',
	'$loc','$city','$aimage','$aimage1','$aimage2','$aimage3','$aimage4','$uid','$status','$fimage','$fimage1','$fimage2','$totalfloor', '$isFeatured','Apartment')";
	...
	if($result)
		...
		{
			$error="<p class='alert alert-danger'>Property Not Inserted Some Error</p>";
		}
}							
?>
<!DOCTYPE html>
	...
	<div class="row">
		<div class="col-md-2">
			<div class="sidebar">
				...
				<a  href="addOffice.php" class="active">Add Office</a>
...
<div class="description">
	<h5 class="text-secondary">Add Office</h5><hr>
	<?php echo $error; ?>
	<?php echo $msg; ?>
