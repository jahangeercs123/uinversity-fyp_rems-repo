...
if(isset($_REQUEST['reg']))
{
	...
	else
	{
		...
		if(!empty($name) && !empty($email) && !empty($phone) && !empty($pass))
		{
			...
			$sql="INSERT INTO user (uname,uemail,uphone,upass,utype,uimage) VALUES ('$name','$email','$phone','$pass','$utype','NULL')";
...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <div class="page-wrappers login-body full-row bg-gray">
            ...
            <div class="shadow-sm  bg-white rounded m-3 col-lg-4">
            	<div class="container">
                	<div class="loginbox">
                        <div class="login-right">
							<div class="login-right-wrap">
								...
								<div class="text-center dont-have mb-4">Already have an account? <a href="login.php">Login</a></div>
