...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <!--	Banner   --->
        <div class="banner-full-row page-banner banner_color bg-secondary"  style="">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
					...
					<div class="col-lg-8">
                        <div class="row">
							...
							if(isset($_REQUEST['filter']))
							{
								...
								$sql="SELECT property.*, user.uname FROM `property`,`user` WHERE property.uid=user.uid and ptype='{$type}' and stype='{$stype}' and city='{$city}'";
                            ...
                            <div class="col-md-6">
                                <div class="featured-thumb hover-zoomer mb-4">
                                    <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                        ...
                                        <div class="sale bg-success text-white">For <?php echo $row['3'];?></div>
                                        <div class="price text-primary text-capitalize">RS:<?php echo $row['10'];?> <span class="text-white"><?php echo $row['11'];?> Sqft</span></div>
                                    ...
                                    <div class="featured-thumb-data shadow-one">
                                        <div class="p-4">
                                            ...
                                            <span class="location text-capitalize"><i class="fas fa-map-marker-alt text-success"></i> <?php echo $row['12'];?></span>  <span class="location text-capitalize ml-5">Type : <?php echo $row['28'];?></span></div>
