...
if(isset($_POST['add']))
{
	...
	size='{$asize}', price='{$price}',`location`='{$loc}', city='{$city}', `status`='{$status}', 
	
	`uid`='{$uid}' ,duration='{$duration}'  WHERE pid = {$pid}";
...
<div class="description">
    <h5 class="text-secondary">Update</h5><hr>
        ...
        <div class="row">
            <div class="col-xl-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control" name="price" value="<?php echo $row['11']; ?>" placeholder="Enter Price">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control" name="city" value="<?php echo $row['13']; ?>" placeholder="Enter City">
                    </div>
                </div>
            ...
            <div class="col-xl-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control" name="asize"  value="<?php echo $row['10']; ?>" placeholder="Enter Area Size (in sqrt)">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-lg-3 col-form-label">Address</label>
                    <div class="col-lg-9">
                        <input type="text" class="form-control" name="loc" value="<?php echo $row['12']; ?>"  placeholder="Enter Address">
                    </div>
                </div>
